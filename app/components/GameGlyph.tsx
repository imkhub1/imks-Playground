import type { GlyphId } from "@/app/lib/games";
...
function Glutton() {
  return (
    <g>
      <path d="M44 57 L70 44 A29 29 0 1 0 70 70 Z" fill={AC} />
...
const ICON_MAP: Record<GlyphId, () => React.ReactElement> = {
  block: Block,
  cascade: Cascade,
  serpent: Serpent,
  glutton: Glutton,
...
export default function GameGlyph({ icon }: GameGlyphProps) {
