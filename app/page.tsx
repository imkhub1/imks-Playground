  ...
  return (
    ...
    >
      ...
      <div style={{ padding: "10px 12px 12px" }}>
        <div className="mono" style={{ fontSize: 12, fontWeight: 700, color: "var(--text)", marginBottom: 3 }}>
          {game.title}
        </div>
...
function SectionHead({ num, title }: { num: string; title: string }) {
  return (
    <div style={{ marginBottom: 40 }}>
      <div
        className="mono"
        style={{ fontSize: 11, fontWeight: 700, letterSpacing: "0.22em", color: "var(--accent)", marginBottom: 10 }}
      >
        {num}
      </div>
      <h2
        className="mono"
        style={{ margin: 0, fontSize: "clamp(22px, 4vw, 34px)", fontWeight: 800, color: "var(--text)", letterSpacing: "-0.01em" }}
      >
        {title}
      </h2>
      <div style={{ marginTop: 14, height: 2, width: 48, background: "var(--accent)", borderRadius: 2 }} />
    </div>
  );
}

const TIME_MOCKS = ["2 min ago", "5 min ago", "8 min ago", "12 min ago", "18 min ago", "24 min ago", "31 min ago"];
    ...
    <div className="view-enter">
      ...
      >
        ...
        <div style={{ position: "relative", zIndex: 1, textAlign: "center", maxWidth: 720 }}>
          ...
          >
            ▸ INSERT A COIN<span style={{ animation: "none", opacity: 0.7 }}>_</span>
          </div>
          <h1
            className="mono"
            style={{
          ...
          >
            THE CLASSIC<br />
            <span style={{ color: "var(--accent)" }}>ARCADE</span><br />
            IS BACK
          </h1>
          <p
            style={{
          ...
          >
            Play the best classics directly in your browser.
            No downloads. No cost. Just pure fun.
          </p>
      ...
      {/* ── WHY ─────────────────────────────────────────────────────────────── */}
      <section className="reveal" style={{ maxWidth: 1240, margin: "0 auto", padding: "80px 24px" }}>
        ...
        >
          {[
            { icon: "GAMEPAD", title: "CLASSIC GAMES",   desc: "Breakout, Tetris, Snake and more. The best retro arcades all in one place.",                         color: "var(--accent)" },
            { icon: "FREE",    title: "100% FREE",        desc: "No subscriptions, no hidden fees. Every game available at absolutely no cost.",                       color: "#00f5ff" },
            { icon: "TROPHY",  title: "LEADERBOARDS",    desc: "Compete with players worldwide. Climb the ranks and prove you are the best.",                          color: "#ff006e" },
            { icon: "ROCKET",  title: "ALWAYS GROWING",  desc: "New games added constantly. Come back often — there will always be something new to play.",            color: "#aa00ff" },
          ].map((f, i) => (
            <div
              key={i}
              style={{
            ...
            >
              ...
              <div className="mono" style={{ fontSize: 13, fontWeight: 700, letterSpacing: "0.1em", color: "var(--text)" }}>
                {f.title}
              </div>
      ...
      {/* ── GAMES PREVIEW ────────────────────────────────────────────────────── */}
      <section className="reveal" style={{ maxWidth: 1240, margin: "0 auto", padding: "0 24px 80px" }}>
      ...
      <section
        className="reveal"
        style={{ background: "var(--surface-1)", borderTop: "1px solid var(--border)", borderBottom: "1px solid var(--border)", padding: "60px 24px" }}
      >
        <div
          style={{
            maxWidth: 900,
        ...
        >
          {[
            ...
            <div key={i} style={{ transitionDelay: `${i * 90}ms` }}>
              <div
                className="mono"
                style={{ fontSize: "clamp(32px, 5vw, 52px)", fontWeight: 800, color: "var(--accent)", lineHeight: 1 }}
              >
                {st.n}
              </div>
              <div className="mono" style={{ fontSize: 13, fontWeight: 700, letterSpacing: "0.18em", color: "var(--text)", marginTop: 8 }}>
                {st.u}
              </div>
              <div style={{ fontSize: 12, color: "var(--text-faint)", marginTop: 4, letterSpacing: "0.04em" }}>
                {st.s}
              </div>
            </div>
          ))}
      ...
      <section className="reveal" style={{ maxWidth: 1240, margin: "0 auto", padding: "80px 24px" }}>
        ...
        >
              ...
              {tickerRows.map((r, i) => (
                <div
                  ...
                  style={{
                    ...
                    gap: 12,
                    padding: "10px 20px",
                    borderBottom: i < tickerRows.length - 1 ? "1px solid var(--border)" : "none",
                    animation: `rowIn 0.4s ease both`,
                    animationDelay: `${i * 60}ms`,
                  }}
                >
                  <span className="mono" style={{ fontSize: 12, fontWeight: 700, color: "var(--accent)", flex: "0 0 80px", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                    {r.player}
                  </span>
                  <span style={{ fontSize: 12, color: "var(--text-muted)", flex: 1, minWidth: 0, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                    ▸ {r.gameTitle}
                  </span>
                  <span className="mono" style={{ fontSize: 12, fontWeight: 700, color: "var(--text)", whiteSpace: "nowrap" }}>
                    +{r.score.toLocaleString("en-US")}
                  </span>
                  <span className="mono" style={{ fontSize: 10, color: "var(--text-faint)", whiteSpace: "nowrap" }}>
                    {TIME_MOCKS[i] ?? ""}
                  </span>
                </div>
              ))}
          ...
          >
            ...
            >
              <span className="mono" style={{ fontSize: 11, fontWeight: 700, letterSpacing: "0.16em", color: "var(--accent)" }}>
                ▸ TOP PLAYERS TODAY
              </span>
              <Link
                href="/hall-of-fame"
                className="mono"
                style={{ fontSize: 10, color: "var(--text-faint)", letterSpacing: "0.1em", textDecoration: "none" }}
              >
                SEE HALL →
              </Link>
            </div>
            <div style={{ padding: "8px 0" }}>
              {topPlayers.map((r, i) => {
                const rankColor = i === 0 ? "var(--gold)" : i === 1 ? "var(--silver)" : i === 2 ? "var(--bronze)" : "var(--text-faint)";
                const barW = 100 - i * 15;
                return (
                  <div
                    key={i}
                  ...
                  >
                    <span className="mono" style={{ fontSize: 12, fontWeight: 700, color: rankColor, width: 28 }}>
                      #{String(r.rank).padStart(2, "0")}
                    </span>
                    <div style={{ flex: 1, minWidth: 0 }}>
                      <div className="mono" style={{ fontSize: 12, fontWeight: 700, color: "var(--text)", marginBottom: 4, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                        {r.player}
                      </div>
                      <div style={{ height: 3, background: "var(--border)", borderRadius: 2, overflow: "hidden" }}>
                        <div style={{ height: "100%", width: `${barW}%`, background: rankColor, borderRadius: 2, transition: "width 0.6s ease" }} />
                      </div>
                    </div>
                    <span className="mono" style={{ fontSize: 12, fontWeight: 700, color: "var(--text-muted)", whiteSpace: "nowrap" }}>
      ...
      <section
        className="reveal"
        style={{ background: "var(--surface-1)", borderTop: "1px solid var(--border)", borderBottom: "1px solid var(--border)", padding: "80px 24px" }}
      >
        <div style={{ maxWidth: 1240, margin: "0 auto" }}>
          ...
          >
            ...
            >
              <div className="mono" style={{ fontSize: 10, fontWeight: 700, letterSpacing: "0.18em", color: "var(--text-faint)", marginBottom: 6 }}>
                SINGLE PLAN
              </div>
              <div className="mono" style={{ fontSize: 18, fontWeight: 800, color: "var(--text)", marginBottom: 16 }}>
                VAULT PLAYER
              </div>
              <div style={{ display: "flex", alignItems: "baseline", gap: 8, marginBottom: 6 }}>
                <span className="mono" style={{ fontSize: 56, fontWeight: 800, color: "var(--accent)", lineHeight: 1 }}>$0</span>
                <span className="mono" style={{ fontSize: 13, color: "var(--text-faint)" }}>/ ALWAYS</span>
              </div>
              <div className="mono" style={{ fontSize: 10, color: "var(--text-faint)", letterSpacing: "0.12em", marginBottom: 24 }}>
              ...
              <ul style={{ margin: "0 0 28px", padding: 0, listStyle: "none", display: "flex", flexDirection: "column", gap: 10 }}>
                {[
                  ...
                  <li key={item} style={{ display: "flex", gap: 10, fontSize: 13.5, color: "var(--text-muted)" }}>
              ...
              <p style={{ textAlign: "center", margin: "14px 0 0", fontSize: 11, color: "var(--text-faint)" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
              {[
                ...
                >
                  <div className="mono" style={{ fontSize: 12, fontWeight: 700, letterSpacing: "0.1em", color: "var(--accent)", marginBottom: 10 }}>
                    {item.q}
                  </div>
